								...
								<c:when test="${empty sessionScope.userId}">
									<div class="top-login">
										<a style="color: black;" data-toggle="modal"
											data-target="#sem-signup" data-dismiss="modal">회원가입</a>
									</div>
									<div class="top-login">
										<a style="color: black" data-toggle="modal"
											data-target="#sem-login" data-dismiss="modal">로그인</a>
									</div>
								</c:when>
								<c:otherwise>
									<div class="top-login">
...
<!-- 여기 -->							<li class="page-scroll"><a href="controller?command=selectPersonResumeByPersonId"
	...
	<div class="modal fade seminor-login-modal" data-backdrop="static"
		id="sem-login" style="padding-top: 250px;">
					...
					<form class="seminor-login-form" method="post" action="controller">
						...
						<div class="form-group">
							<input type="password" class="form-control" name="userPwd"
								...
								class="form-control-placeholder" for="pwd">비밀번호</label>
						...
						<div class="forgot-pass-fau text-center pt-3">
							...
							<a href="#" class="text-primary-fau"><span
								data-toggle="modal" data-target="#sem-signup"
								data-dismiss="modal">회원가입</span></a>

						</div>
						<div class="create-new-fau text-center pt-3"></div>
					</form>
	...
	<!-- 회원가입  -->
	<div class="modal fade seminor-login-modal" data-backdrop="static"
		id="sem-signup" style="padding-top: 250px;">
		<div class="modal-dialog modal-dialog-centered" style="width: 20%">
			<div class="modal-content">
				...
				<div class="modal-body seminor-login-modal-body">
					...
					<form class="seminor-login-form" method="post" action="controller">
						<input type="hidden" class="form-control" name="command"
							value="signup"> <input type="hidden" class="form-control"
							name="perOrCom" value="Person">
						<div class="form-group">
							<input type="text" name="signId" class="form-control" required
								autocomplete="off"> <label
								class="form-control-placeholder" for="id">ID</label>
						</div>
						<div class="form-group">
							<input type="password" name="signPwd" class="form-control"
								required autocomplete="off"> <label
								class="form-control-placeholder" for="pwd">비밀번호</label>
						</div>

						<div class="form-group">
							<input type="text" name="signPhone" class="form-control" required
								autocomplete="off"> <label
								class="form-control-placeholder" for="phone">연락처(ex.
								010-1234-1234)</label>
						</div>
