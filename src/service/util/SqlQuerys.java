...
// 개인페이지에서 스크랩된 회사정보 표출
   ...
   String SCRAP_P_C_LIST_PERSON_RESUME = "SELECT B.PERSON_ID, A.* FROM SCRAP_PERSON A, PERSON_RESUME B WHERE A.PERSON_TARGET_ID = B.PERSON_ID AND A.COMPANY_SCRAPER_ID = ?";
