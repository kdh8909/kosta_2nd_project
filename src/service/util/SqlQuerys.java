...
public interface SqlQuerys {
   ...
   String P_LOGIN = "SELECT * FROM person_login WHERE person_id = ? ";
   ...
   String P_ADD_RESUME = "INSERT INTO PERSON__RESUME VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

   // 개인 이력서 조회 (전체)

   String P_SELECT_RESUME_ALL = "SELECT * FROM PERSON__RESUME";

   // 개인 이력서 조회 (사람별)

   String P_SELECT_RESUME_BY_ID = "SELECT * FROM PERSON__RESUME WHERE person_id = ?";
